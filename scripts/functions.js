...
endpoint.documents.batchUpdate.post = function(documentId, httpOptions) {
    if (!documentId) {
...
endpoint.documents.post = function(httpOptions) {
    var url = parse('/documents');
    sys.logs.debug('[googledocs] POST from: ' + url);
    var options = checkHttpOptions(url, httpOptions);
    return endpoint._post(options);
};
...
endpoint.documents.get = function(documentId, httpOptions) {
    ...
    var url = parse('/documents/:documentId', [documentId]);
    sys.logs.debug('[googledocs] GET from: ' + url);
    var options = checkHttpOptions(url, httpOptions);
