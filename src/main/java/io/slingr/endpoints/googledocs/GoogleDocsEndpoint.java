package io.slingr.endpoints.googledocs;
...
@SlingrEndpoint(name = "googledocs", functionPrefix = "_")
public class GoogleDocsEndpoint extends HttpEndpoint {

    private static final Logger logger = LoggerFactory.getLogger(GoogleDocsEndpoint.class);
    private static final String API_URL = "https://docs.googleapis.com/v1";
